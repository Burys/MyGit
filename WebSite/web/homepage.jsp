    ...
    <div class = "environment">
        ...
        <div class = "environment-branches">
            <div class = "environment-branch">
                ...
                <div class = "environment-branch-content">学生宿舍</div>
            </div>
            <div class = "environment-branch">
                <img class = "environment-branch-pic" src="images/pic_environment_branch2.jpg">
                <div class = "environment-branch-content">专业录播室</div>
            </div>
            <div class = "environment-branch">
                <img class = "environment-branch-pic" src="images/pic_environment_branch3.jpg">
                <div class = "environment-branch-content">校园食堂</div>
            </div>
            <div class = "environment-branch">
                <img class = "environment-branch-pic" src="images/pic_environment_branch4.jpg">
                <div class = "environment-branch-content">校园超市</div>
            </div>
        </div>
        <div class = "environment-main">
            <img class = "environment-main-pic" src="images/pic-environment-main.jpg">
            <div class = "environment-main-content">学校大门</div>
        </div>
        <div class = "environment-branches">
            <div class = "environment-branch">
                <img class = "environment-branch-pic" src="images/pic_environment_branch5.png">
                <div class = "environment-branch-content">校园研修室</div>
            </div>
            <div class = "environment-branch">
                <img class = "environment-branch-pic" src="images/pic_environment_branch6.png">
                <div class = "environment-branch-content">学生自习室</div>
            </div>
            <div class = "environment-branch">
                <img class = "environment-branch-pic" src="images/pic_environment_branch7.png">
                <div class = "environment-branch-content">授课教室</div>
            </div>
            <div class = "environment-branch">
                <img class = "environment-branch-pic" src="images/pic_environment_branch8.png">
                <div class = "environment-branch-content">校园图书角</div>
            </div>
        </div>
    </div>
    <%
